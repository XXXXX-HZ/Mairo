...
public class Mario : Agent
{
    ...
    {
        var faceDirection = actionBuffers.DiscreteActions[0]; // > 0 for right, < 0 for left
        ...
        /*var isDashingtest = actionBuffers.DiscreteActions[1];
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        if (!inputFreezed)
        {
            //" Move Horizontal"; // > 2 for right,  1 for left
        ...
        /* Debug.Log((discreteActionsOut[0], discreteActionsOut[1], discreteActionsOut[3]));*/
    }
}